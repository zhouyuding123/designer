  ...
  <div>
    ...
    <div class="insidewrap">
        <div class="flex al-c">
            ...
            <div class="PublishWorks" @click="toUploadWorks">
                发布作品
            </div>
        </div>
    ...
    <el-tab-pane label="私密作品" name="1"></el-tab-pane>
     ...
     <div class="list_free">
      <div class="list_free_list">
                <waterfall :cols="Math.floor(windowWidth/300)>=5?5:Math.floor(windowWidth/300)" :dataList="myworkList" @loadmore="loadmore" @scroll="scroll">
   <div class="masonry" v-for="(item, index) in myworkList" :key="index">
        ...
        <el-dropdown-menu slot="dropdown" >
            <el-dropdown-item :command="{id:item.id,title:'edit'}">编辑</el-dropdown-item>
            <el-dropdown-item :command="{id:item.id,title:'share'}">分享</el-dropdown-item>
            <el-dropdown-item :command="{id:item.id,title:'del'}">删除</el-dropdown-item>
        </el-dropdown-menu>
        </el-dropdown> -->
           ...
           <div class="list_title">
                  <div class="list_title_title"> 
                      ...
                      <div class="list_title_title_title_tag flex"  >
                        <div  v-for="(tag,i) in item.label.split(',')||item.label.split('，')" :key="i">#{{tag}}</div>
                        <!-- <div>礼服</div> -->
                      </div>
                      <div class="flex icon al-c">
                        <div class="flex al-c coloccc font12 margin-right8">
                          <img src="@/assets/imgers/icon/15228@2x.png" class="margin-right4" alt="">
                          999
                        </div>
                        <div class="flex al-c coloccc font12 margin-right8">
                          <img src="@/assets/imgers/icon/15225@2x.png" class="margin-right4" alt="">
                          999
                        </div>
                       <div class="flex al-c coloccc font12 margin-right8">
                          <img src="@/assets/imgers/icon/15229@2x.png" class="margin-right4" alt="">
                          999
                        </div>
                       <div class="flex al-c coloccc font12 margin-right8">
                          <img src="@/assets/imgers/icon/15227@2x.png" class="margin-right4" alt="">
                          999
                        </div>
                      </div>
                  </div>
...
<script>
import {getMyWorksApi} from "@/urls/wsUrl.js";
...
export default {
    ...
    created(){
        this.Works.username=this.$route.query.username
        this.getmyworkList()
